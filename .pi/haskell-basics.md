# Haskell Basics for jktlug Website Development

This guide covers the Haskell concepts and patterns you need to
understand in order to work on the jktlug website. It is not a
...
combinators**. `jktlug.Parser` is a tiny parser library built from
...
- `jktlug-website.cabal` — declares the package, executables, modules,
  and dependencies

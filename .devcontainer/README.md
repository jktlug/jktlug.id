# jktlug Website Dev Container

This directory contains the [Development Container](https://containers.dev/) configuration for the jktlug (Tokyo Linux Users Group) website project.
...
```bash
# Build the image
docker build -t jktlug-dev -f .devcontainer/Dockerfile .
